...
d.emb = load('/home/romy.beaute/projects/hypnomed/diffusion_embedding/emb_matrices/group_run-1_run-2_run-3_embedding.mat');
...
function [emb_state,state_name] = get_state_group(d,state_wanted,interaction)
    ...
    if strcmp(state_wanted,'block-1')
        state_name = "block-1";
        state_index = d.state(1);
    elseif strcmp(state_wanted,'block-2')
        state_name = "block-2";
        state_index = d.state(2);
    elseif strcmp(state_wanted,'block-3')
        state_name = "block-3";
