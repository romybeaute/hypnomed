...
mat_folder = '/mnt/data/romy/hypnomed/git/diffusion_embedding/emb_matrices'
#########################
...
group_emb_map = mat_folder+'/group_{}_embedding_new.mat'.format(emb_condition)
...
try:
    ...
    print('Loading ',group_emb_map)
except:
    emb_mat = selected_embedding(emb_condition,sublist,npy_folder)
